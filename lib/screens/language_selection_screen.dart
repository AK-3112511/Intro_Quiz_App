...
class _LanguageSelectionScreenState extends State<LanguageSelectionScreen> with TickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> languages = [
    {
      'name': 'College Life Pack 🎓',
      'icon': Icons.flutter_dash,
      'color': Colors.blueAccent,
      'description': 'Attendance, Maggi & chaos',
    },
    {
      'name': 'Tech Madness Pack 🤖⚡',
      'icon': Icons.android,
      'color': Colors.greenAccent,
      'description': 'WiFi, bugs & beyond',
    },
    {
      'name': 'Meme Mania Pack 🐸🤣',
      'icon': Icons.code,
      'color': Colors.amberAccent,
      'description': 'Random LOL guaranteed',
    },
  ];
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Select your preferred category to get customized questions',
                              style: TextStyle(
                                color: Colors.grey.shade300,
                                fontSize: 14,
                              ),
